...
mixin _$OutcomeView {
 ...
 String? get competitorAccountId; CounterpartyView? get competitor; LossReason? get lossReason; double? get competitorPrice; String? get narrative; String? get currency; String? get notes;/// The proof filed with a WON claim — the award letter, the signed PO,
...
/// `files` field to fill it from.
 List<ActivityAttachmentView> get attachments; DateTime get submittedAt; String? get submittedBy; ActorView? get submittedByUser; DateTime? get confirmedAt; String? get confirmedBy; ActorView? get confirmedByUser; DateTime? get rejectedAt; String? get rejectedBy; ActorView? get rejectedByUser; String? get rejectionReason; ProjectStage get previousStage;
...
@useResult
$Res call({
 String id, String projectId, String projectName, OutcomeType type, OutcomeStatus status, String? distributorAccountId, CounterpartyView? distributor, double? value, DateTime? soldAt, List<ProductCategory> categories, int? unitsSupplied, int? unitsTotal, String? buyerContactId, String? competitorAccountId, CounterpartyView? competitor, LossReason? lossReason, double? competitorPrice, String? narrative, String? currency, String? notes, List<ActivityAttachmentView> attachments, DateTime submittedAt, String? submittedBy, ActorView? submittedByUser, DateTime? confirmedAt, String? confirmedBy, ActorView? confirmedByUser, DateTime? rejectedAt, String? rejectedBy, ActorView? rejectedByUser, String? rejectionReason, ProjectStage previousStage
});
...
as List<ActivityAttachmentView>,submittedAt: null == submittedAt ? _self.submittedAt : submittedAt // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String projectId,  String projectName,  OutcomeType type,  OutcomeStatus status,  String? distributorAccountId,  CounterpartyView? distributor,  double? value,  DateTime? soldAt,  List<ProductCategory> categories,  int? unitsSupplied,  int? unitsTotal,  String? buyerContactId,  String? competitorAccountId,  CounterpartyView? competitor,  LossReason? lossReason,  double? competitorPrice,  String? narrative,  String? currency,  String? notes,  List<ActivityAttachmentView> attachments,  DateTime submittedAt,  String? submittedBy,  ActorView? submittedByUser,  DateTime? confirmedAt,  String? confirmedBy,  ActorView? confirmedByUser,  DateTime? rejectedAt,  String? rejectedBy,  ActorView? rejectedByUser,  String? rejectionReason,  ProjectStage previousStage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OutcomeView() when $default != null:
return $default(_that.id,_that.projectId,_that.projectName,_that.type,_that.status,_that.distributorAccountId,_that.distributor,_that.value,_that.soldAt,_that.categories,_that.unitsSupplied,_that.unitsTotal,_that.buyerContactId,_that.competitorAccountId,_that.competitor,_that.lossReason,_that.competitorPrice,_that.narrative,_that.currency,_that.notes,_that.attachments,_that.submittedAt,_that.submittedBy,_that.submittedByUser,_that.confirmedAt,_that.confirmedBy,_that.confirmedByUser,_that.rejectedAt,_that.rejectedBy,_that.rejectedByUser,_that.rejectionReason,_that.previousStage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String projectId,  String projectName,  OutcomeType type,  OutcomeStatus status,  String? distributorAccountId,  CounterpartyView? distributor,  double? value,  DateTime? soldAt,  List<ProductCategory> categories,  int? unitsSupplied,  int? unitsTotal,  String? buyerContactId,  String? competitorAccountId,  CounterpartyView? competitor,  LossReason? lossReason,  double? competitorPrice,  String? narrative,  String? currency,  String? notes,  List<ActivityAttachmentView> attachments,  DateTime submittedAt,  String? submittedBy,  ActorView? submittedByUser,  DateTime? confirmedAt,  String? confirmedBy,  ActorView? confirmedByUser,  DateTime? rejectedAt,  String? rejectedBy,  ActorView? rejectedByUser,  String? rejectionReason,  ProjectStage previousStage)  $default,) {final _that = this;
switch (_that) {
case _OutcomeView():
return $default(_that.id,_that.projectId,_that.projectName,_that.type,_that.status,_that.distributorAccountId,_that.distributor,_that.value,_that.soldAt,_that.categories,_that.unitsSupplied,_that.unitsTotal,_that.buyerContactId,_that.competitorAccountId,_that.competitor,_that.lossReason,_that.competitorPrice,_that.narrative,_that.currency,_that.notes,_that.attachments,_that.submittedAt,_that.submittedBy,_that.submittedByUser,_that.confirmedAt,_that.confirmedBy,_that.confirmedByUser,_that.rejectedAt,_that.rejectedBy,_that.rejectedByUser,_that.rejectionReason,_that.previousStage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String projectId,  String projectName,  OutcomeType type,  OutcomeStatus status,  String? distributorAccountId,  CounterpartyView? distributor,  double? value,  DateTime? soldAt,  List<ProductCategory> categories,  int? unitsSupplied,  int? unitsTotal,  String? buyerContactId,  String? competitorAccountId,  CounterpartyView? competitor,  LossReason? lossReason,  double? competitorPrice,  String? narrative,  String? currency,  String? notes,  List<ActivityAttachmentView> attachments,  DateTime submittedAt,  String? submittedBy,  ActorView? submittedByUser,  DateTime? confirmedAt,  String? confirmedBy,  ActorView? confirmedByUser,  DateTime? rejectedAt,  String? rejectedBy,  ActorView? rejectedByUser,  String? rejectionReason,  ProjectStage previousStage)?  $default,) {final _that = this;
switch (_that) {
case _OutcomeView() when $default != null:
return $default(_that.id,_that.projectId,_that.projectName,_that.type,_that.status,_that.distributorAccountId,_that.distributor,_that.value,_that.soldAt,_that.categories,_that.unitsSupplied,_that.unitsTotal,_that.buyerContactId,_that.competitorAccountId,_that.competitor,_that.lossReason,_that.competitorPrice,_that.narrative,_that.currency,_that.notes,_that.attachments,_that.submittedAt,_that.submittedBy,_that.submittedByUser,_that.confirmedAt,_that.confirmedBy,_that.confirmedByUser,_that.rejectedAt,_that.rejectedBy,_that.rejectedByUser,_that.rejectionReason,_that.previousStage);case _:
  return null;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,projectId,projectName,type,status,distributorAccountId,distributor,value,soldAt,const DeepCollectionEquality().hash(_categories),unitsSupplied,unitsTotal,buyerContactId,competitorAccountId,competitor,lossReason,competitorPrice,narrative,currency,notes,const DeepCollectionEquality().hash(_attachments),submittedAt,submittedBy,submittedByUser,confirmedAt,confirmedBy,confirmedByUser,rejectedAt,rejectedBy,rejectedByUser,rejectionReason,previousStage]);
