...
mixin _$MyAttainmentResponse {
 ...
 bool? get success; String? get message;/// Never `null` on a 200 — an absent target is `targets: []`, not a
/// missing payload.
 MyAttainmentView get data; ApiResponseMeta? get meta;
...
class _MyAttainmentResponse implements MyAttainmentResponse {
  const _MyAttainmentResponse({this.success, this.message, this.data = const MyAttainmentView(), this.meta});
...
/// missing payload.
@override@JsonKey() final  MyAttainmentView data;
