...
final Map<String, String> enUS = {
  ...
  // ============================ My targets ============================
  'targets_section_title': 'My targets',
  'targets_view_year': 'Full year',
  'targets_year_title': 'Targets by quarter',
  'target_quarter_q1': 'Q1 · Jan–Mar',
  'target_quarter_q2': 'Q2 · Apr–Jun',
  'target_quarter_q3': 'Q3 · Jul–Sep',
  'target_quarter_q4': 'Q4 · Oct–Dec',
  'target_quarter_current': 'Current',
  'target_quarter_error': 'Could not load this quarter',
  'targets_empty_title': 'No target published yet',
  'targets_empty_subtitle':
      'Once your manager publishes a target for this quarter it will show up here.',
  'target_metric_sales_value': 'Sales value',
  'target_metric_units': 'Units supplied',
  'target_metric_wins': 'Wins',
  'target_attained': 'Achieved',
  'target_goal': 'Target',
  'target_remaining': 'Remaining',
  'target_remaining_none': 'Target reached',
  'target_period_closed': '· Closed',
  'target_days_elapsed': 'Day {elapsed} of {total}',
  'target_confirmed_wins': '{count} confirmed',
  // Only shown after a mid-period transfer, when the quarter arrives as two
  // halves and neither number alone answers "how am I doing".
  'target_combined_title': 'Combined for the period',
  'target_combined_subtitle': 'Both halves of your quarter',
